    ...
    if (mobile) {
        return (
            <div className={classes.mobileWrapper}>
                <IconBtn icon={GitHub} m={1} href="https://github.com/smltrs0" />
                <IconBtn icon={Instagram} m={1} href="https://www.instagram.com/sam.ltrias/" />
                <IconBtn icon={LinkedIn} m={1} href="https://www.linkedin.com/in/samuel-trias/" />
            </div>
        );
    } else {
        return (
