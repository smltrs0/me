...
const useStyles = makeStyles((theme) => ({
    ...
    tabs: {
        borderRight: (props) => (props.isMobile ? "none" : `1px solid ${theme.palette.primary.main}`),
        borderBottom: (props) => (!props.isMobile ? "none" : `1px solid ${theme.palette.primary.main}`),
    ...
    indicator: {
        width: (props) => (props.isMobile ? "100%" : "inherit"),
